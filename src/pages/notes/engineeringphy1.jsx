...
const dispatch = useDispatch();
    ...
    const physcisNotes = notes.filter((note) => note.subject === "Physics");

    return (
        <MainLayout>
            <title>Engineering Physics - I | NITKeChhore</title>
                    ...
                    <section className="mb-10">
                        ...
                        {!loading && (
                            <p className="text-sm text-base-content/60 font-secondary">
                                {physcisNotes.length}{" "}
                                {physcisNotes.length === 1 ? "note" : "notes"} available
                            </p>
                        )}
                    </section>
